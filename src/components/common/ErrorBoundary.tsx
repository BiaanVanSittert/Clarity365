      ...
      return (
        <div className="flex flex-col items-center justify-center h-full min-h-[300px] p-8 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-white bg-slate-900 hover:bg-slate-800 rounded-sm transition-colors"
          >
            <RotateCcw size={12} />
            <span>Retry</span>
          </button>
          {this.state.error && (
            <details className="mt-4 text-left w-full max-w-lg">
              ...
              <pre className="mt-2 p-3 bg-slate-50 border border-slate-200 rounded-sm text-[10px] text-slate-600 font-mono overflow-x-auto whitespace-pre-wrap">
