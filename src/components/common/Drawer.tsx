...
export const Drawer: React.FC<DrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-none transition-opacity" onClick={onClose} />
      <div className="fixed inset-y-0 right-0 pl-10 max-w-full flex">
        <div className={`w-screen ${widthClasses[width]} bg-white border-l border-[#CBD5E1] shadow-2xl flex flex-col`}>
